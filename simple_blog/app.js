...
//Routes
app.get('/', (req, res)=>{
    res.render("index.ejs", {header: homeHeader, content: homeStartingContent});
});
app.get('/about', (req, res)=>{
    res.render("index.ejs", {header: aboutHeader, content: aboutContent});
});
app.get('/contact', (req, res)=>{
    res.render("index.ejs", {header: contactHeader, content: contactContent});
});
